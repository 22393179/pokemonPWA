...
// ✅ Pide permiso solo una vez al inicio
...
// ✅ Usa directamente el método del service worker registrado
async function enviarNotificacion(pokemon) {
  ...
  // Si se otorgó permiso, muestra la notificación
  if (Notification.permission === "granted" && "serviceWorker" in navigator) {
    const registration = await navigator.serviceWorker.ready;

    registration.showNotification(`Pokémon consultado: ${pokemon.name}`, {
